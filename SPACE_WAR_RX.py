...
#                 self.screen.blit(text1, (820, 670))
screen = Tk()
c = Canvas(screen, width=900, height=700, bg='white')
c.pack()
...
def main():
    ...
    photo_image_ship = PhotoImage(file="Images/ship.png")
    ship_image = c.create_image(ship_x, ship_y, anchor=NW, image=photo_image_ship)

    game.on_next(
        screen.bind("<Key>", lambda evnt, ship=ship_image: key(evnt, ship))
    )
